            ...
            if (c != null)
            {
                ...
                var list1 = from b in list
                            ...
                            select new
                            {
                                ...
                                Gender = cv.Gender,
                                Address = cv.NoiO ,
                                NationLive= rc.GetNation((int)cv.NationLive).Name,
                                ProvinceLive = rc.GetLocation((int)cv.PorvinceLive).Name,
                                DistrictLive= rc.GetDistrict((int)cv.DistrictLive).Name,
                                WardLive= rc.GetWard((int)cv.WardLive).Name,
                                School = edu.School1,
                                Major = edu.Major1,
                                Score = edu.Gpa1,
